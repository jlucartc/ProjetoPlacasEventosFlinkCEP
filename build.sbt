...
libraryDependencies += "org.apache.flink" %% "flink-runtime" % "1.10.0" % Test

libraryDependencies += "org.apache.flink" %% "flink-runtime-web" % "1.10.0" % Test

libraryDependencies += "org.apache.flink" %% "flink-clients" % "1.10.0"

libraryDependencies += "log4j" % "log4j" % "1.2.17"

libraryDependencies += "org.apache.flink" %% "flink-cep" % "1.10.0"
...
libraryDependencies += "org.apache.flink" % "flink-table-common" % "1.10.0" % "provided"

// https://mvnrepository.com/artifact/org.apache.flink/flink-table-api-scala
libraryDependencies += "org.apache.flink" %% "flink-table-api-scala" % "1.10.0"

// https://mvnrepository.com/artifact/org.apache.flink/flink-table-api-scala-bridge
libraryDependencies += "org.apache.flink" %% "flink-table-api-scala-bridge" % "1.10.0"

// https://mvnrepository.com/artifact/org.apache.flink/flink-table-planner-blink
libraryDependencies += "org.apache.flink" %% "flink-table-planner-blink" % "1.10.0"

// https://mvnrepository.com/artifact/org.apache.flink/flink-table-runtime-blink
libraryDependencies += "org.apache.flink" %% "flink-table-runtime-blink" % "1.10.0"
