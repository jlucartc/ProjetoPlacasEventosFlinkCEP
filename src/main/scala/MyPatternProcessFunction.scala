...
class MyPatternProcessFunction() extends PatternProcessFunction[(String,Double,Double,String,Int,Int),String] with TimedOutPartialMatchHandler[(String,Double,Double,String,Int,Int)]{
    ...
    override def processMatch(events: util.Map[String, util.List[(String,Double,Double,String,Int,Int)]], ctx: PatternProcessFunction.Context, out: Collector[String]): Unit = {
        ...
        events.get("follow").forEach( value => { println("Follow event: "+value._1); out.collect(value._6.toString); })
    ...
    override def processTimedOutMatch(events: util.Map[String, util.List[(String, Double, Double, String, Int, Int)]], ctx: PatternProcessFunction.Context): Unit = {
        ...
        events.get("follow").forEach( value => { println("Rejected event: "+value._1) } )
